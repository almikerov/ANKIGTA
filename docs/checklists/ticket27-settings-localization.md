...
Ticket 01 of panel-rebuild removed the language setting, so the two-language
steps are gone from this list; the guard that nothing outside the string table
holds a Cyrillic constant is automatic and covers the whole resource.
