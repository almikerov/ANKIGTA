...
Locale.strings = {
    ...
    ru = {
        ...
        ["settings.closeAfterRating"] = "Закрывать карточки после оценки",
        ...
        ["settings.close"] = "X",
        ["settings.noMaps"] = "Ни одна карта не загружена",
        ["settings.connectionSettings"] = "Настройки подключения…",
        ["settings.value.true"] = "Включено",
        ["settings.value.false"] = "Выключено",
        ...
        ["settings.error.not_a_placement"] =
            "Сохранённое размещение окон непригодно",
        ["settings.error.wrong_authority"] = "Этой настройкой владеет другая сторона",
        ["settings.error.map_required"] = "Для этой настройки нужна карта",
        ["settings.error.not_saved"] = "Не удалось сохранить настройку",
        ["ui.smaller"] = "Меньше (−0.05)",
        ["ui.larger"] = "Больше (+0.05)",
        ["ui.reset"] = "Сбросить размещение интерфейса",
        ["ui.resetExplanation"] =
            "Возвращает масштаб и все окна к исходным значениям.",
        ["ui.resetDone"] = "Размещение интерфейса сброшено.",
        ["ui.editHud"] = "Редактировать размещение HUD",
        ["ui.editHudExplanation"] =
            "Пока включено, HUD со счётчиками можно перетаскивать мышью.",
        ["ui.hudHandle"] = "Редактирование HUD — перетащите мышью",
        ["review.title"] = "ANKIGTA — Режим повторения",
        ...
        ["diagnostics.title"] = "Диагностика ANKIGTA — вставьте эти строки в отчёт об ошибке",
        ...
        ["f7.filter"] = "Поиск Map Entity",
        ["f7.filterApply"] = "Поиск",
        ["f7.filterResult"] = "Показано %d из %d",
        ["f7.copyOriginal"] = "Original / renamed",
        ["f7.copyNew"] = "New copy",
        ["f7.copyDecisionHint"] =
        ...
        ["inspector.title"] = "Сама карточка",
        ["inspector.tags"] = "Теги",
        ["inspector.tagsHint"] = "через пробел",
        ["inspector.save"] = "Сохранить карточку",
        ["inspector.open"] = "Редактировать карточку",
        ["inspector.close"] = "Скрыть редактор",
        ["inspector.saved"] = "Сохранено",
        ["inspector.loading"] = "Читаю...",
        ["inspector.unreadable"] = "Карточку не удалось прочитать: %s",
        ["f7.teleport"] = "Телепорт",
        ...
        ["notice.studyStateUnavailable"] =
            "Состояния карточек и следующая карточка недоступны: %s",
        ...
        ["notice.noteUpdateFailed"] = "Карточка не изменена: %s",
