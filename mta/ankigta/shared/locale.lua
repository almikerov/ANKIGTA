...
Locale.strings = {
    en = {
        ...
        ["ui.title"] = "ANKIGTA — UI scale and layout",
        ["ui.open"] = "UI scale and layout",
        ["ui.currentScale"] = "UI scale: %.2f",
        ["ui.scaleRange"] = "0.50 to 2.00; the buttons move it by 0.05.",
        ["ui.smaller"] = "Smaller (−0.05)",
        ["ui.larger"] = "Larger (+0.05)",
        ["ui.exactScale"] = "Exact value",
        ["ui.applyScale"] = "Apply",
        ["ui.scaleRejected"] = "UI scale unchanged: %s",
    ...
    ru = {
        ...
        ["ui.title"] = "ANKIGTA — Масштаб и размещение",
        ["ui.open"] = "Масштаб и размещение",
        ["ui.currentScale"] = "Масштаб интерфейса: %.2f",
        ["ui.scaleRange"] = "От 0.50 до 2.00; кнопки меняют его на 0.05.",
        ["ui.smaller"] = "Меньше (−0.05)",
        ["ui.larger"] = "Больше (+0.05)",
        ["ui.exactScale"] = "Точное значение",
        ["ui.applyScale"] = "Применить",
        ["ui.scaleRejected"] = "Масштаб не изменён: %s",
